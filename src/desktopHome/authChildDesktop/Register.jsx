...
const schema = Yup.object({
  ...
  contact_number: Yup.string()
    .matches(
      /^5[0-9]{8}$/,
      "Must be a valid UAE mobile number (e.g., 50xxxxxxx)",
    )
  ...
  const personas = [
    {
      name: "Flashing Floss",
      icon: flashFloss,
      description: "Quick and agile floss master",
    },
    {
      name: "Germ Zapper",
      icon: germZapper,
      description: "Defender against germs",
    },
    {
      name: "Green Gobbler",
      icon: greenGobbler,
      description: "Master of healthy eating",
    },
    {
      name: "Hydro Hero",
      icon: hydroHero,
      description: "Champion of hydration",
    },
    {
      name: "Mighty Man",
      icon: mightyMan,
      description: "Strong and powerful protector",
    },
    {
      name: "Miss Brainy",
      icon: missBrainy,
      description: "Smart and wise leader",
    },
  ];
          ...
          <Form className="space-y-6 font-gtwalsheim px-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 pt-10">
                  ...
                  <div className="flex items-center space-x-2">
                    {values.persona && (
                      <div className="flex items-center space-x-2">
                        <img
                          src={
                            personas.find((p) => p.name === values.persona)
                              ?.icon
                          }
                          alt={values.persona}
              ...
              <div className="relative flex items-center">
                <span className="absolute left-3 text-black font-bold">
                  +971
                </span>
                <Field
                  name="contact_number"
            ...
            <div>
              <label className="flex items-start gap-3 text-sm text-white">
                  ...
                  <Field name="consent">
                    {({ field, form }) => (
                      <div
                        ...
                        onClick={() =>
                          form.setFieldValue("consent", !field.value)
                        }
                      >
                        <motion.div
                ...
                <span>
                  Confirm that your parent or guardian has provided consent.
                  Read our{" "}
